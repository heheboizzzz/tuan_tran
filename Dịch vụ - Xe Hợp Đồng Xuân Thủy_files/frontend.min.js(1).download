...
(self.webpackChunkelementor = self.webpackChunkelementor || []).push([[819], {
    ...
    9501: (e,t)=>{
        ...
        class BackgroundVideo extends elementorModules.frontend.handlers.Base {
            ...
            prepareYTVideo(e, t) {
                ...
                o.background_privacy_mode && (s.host = "http://www.youtube-nocookie.com",
            ...
            activate() {
                ...
                this.apiProvider = elementorFrontend.utils.vimeo) : t.match(/^(?:http?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com)/) && (this.videoType = "youtube",
    ...
    1911: (e,t,n)=>{
        ...
        class VimeoLoader extends i.default {
            getApiURL() {
                return "http://player.vimeo.com/api/player.js"
            }
            getURLRegex() {
                return /^(?:http?:\/\/)?(?:www|player\.)?(?:vimeo\.com\/)?(?:video\/|external\/)?(\d+)([^.?&#"'>]?)/
            }
            isApiLoaded() {
                return window.Vimeo
            }
    ...
    1604: (e,t,n)=>{
        ...
        class YoutubeLoader extends i.default {
            ...
            getURLRegex() {
                return /^(?:http?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com\/(?:(?:watch)?\?(?:.*&)?vi?=|(?:embed|v|vi|user)\/))([^?&"'>]+)/
            }
            isApiLoaded() {
